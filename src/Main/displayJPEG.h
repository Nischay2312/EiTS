...
// /*
//   displayJpeg.h
//   Header file that contains all the functions related to displaying JPEG images.
// */
// /////////////////////////////////////////////////////////////////
#include <JPEGDEC.h>
...
void DrawSplashScreen(){
  ...
  if(!SD.exists(SPLASH_SCREEN_FILE)){
    Serial.println("Splash Screen File not found");
    gfx->println("Splash Screen File not found");
    return;
  }
  else{
    jpegDraw(SPLASH_SCREEN_FILE, jpegDrawCallback, true, 0, 0, gfx->width(), gfx->height());
    delay(2000);
  }
  return;
}